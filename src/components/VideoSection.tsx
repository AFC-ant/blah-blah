          ...
          <div className="space-y-6">
            <div className="relative group">
              <div className="relative aspect-video bg-gradient-to-br from-card to-muted rounded-xl overflow-hidden shadow-card border border-border group-hover:shadow-primary transition-all duration-300">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-background/20 to-muted/40">
                  <div className="text-center">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 bg-primary/20 rounded-full flex items-center justify-center mb-3 sm:mb-4 mx-auto group-hover:bg-primary/30 transition-colors">
                      <svg className="w-6 h-6 sm:w-8 sm:h-8 text-primary ml-1" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M8 5v14l11-7z"/>
                      </svg>
                    </div>
                    <p className="text-primary font-medium text-sm sm:text-base">Play Explainer</p>
                  </div>
                </div>
                
                {/* Video overlay */}
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-background/90 to-transparent p-4 sm:p-6">
                  <h3 className="text-primary font-semibold text-base sm:text-lg mb-1">Professional Explanation</h3>
                  <p className="text-foreground font-medium mb-1 sm:mb-2 text-sm sm:text-base">AFC Investigation Process</p>
