            ...
            <div className="relative">
              <div className="relative overflow-hidden rounded-lg shadow-sm border border-border">
                ...
                <div style={{ position: 'relative', paddingTop: '56.25%' }}>
                  <iframe 
                    src="https://iframe.mediadelivery.net/embed/492019/b46b2662-d115-496d-8f16-9ad6714cc1d2?autoplay=false&loop=false&muted=false&preload=metadata&responsive=true" 
                    loading="lazy" 
